                        ...
                        <form method="post" action="<?= isset($_GET['id']) && isset($_GET['action']) && $_GET['action'] == 'edt' ? 'pdo/edt.php' : 'index.php'; ?>">
                            ...
                            <div class="row gx-3">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <select type="number" name="no_kamar" id="no_kamar" class="form-control" max="999" value="<?= $erow['no_kamar'] ?? ''; ?>">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="index.php?action=del&id=<?= $row['id_bodet'] ?>" class="btn btn-danger">del</a>
                                                </td>
                                            </tr>
                                    <?php
                                        }
